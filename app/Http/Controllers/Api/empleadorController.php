...
class EmpleadorController extends Controller
{
    ...
    public function trabajadores(Request $request){
        ...
        $listaTrabajadores=Empleado::join('servicios as se','empleados.id','=','se.id_empleado')
                                    ...
                                    ->select('us.*','empleados.id as id_empleado','calificacion_empleado','se.id as id_servicio','se.descripcion','se.precio_estandar','espe.nombre as especialidad','log.correo')->get();
    ...
    public function listaDeAceptados(Request $request){
    ...
    /** Metodo para devolver lista de trabajadores en espera atributos necesarios:
     * id_ususario_movil
     */
    public function listaTrabajadoresEspera(Request $request){
        ...
        $id_empleador = Empleado::where('id_usuario_movil','=',$id_usuario)->value('id');
        ...
        $listaTrabajadores=Empleado::join('servicios as se','empleados.id','=','se.id_empleado')
                                    ...
                                    ->select('us.*','solcont.*','empleados.id as id_empleado','calificacion_empleado','espe.id as id_servicio','se.descripcion','se.precio_estandar','espe.nombre as especialidad','log.correo')->get();
    ...
    public function contratosRechazados(Request $request){
        $this->validate($request, [
            'id_usuario_movil' => 'required'
        ]);
...
public function listaGenererica(Request $request){
