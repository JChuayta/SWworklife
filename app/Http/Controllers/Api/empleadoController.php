   ...
   */
   ...
   public function listaDeSolicitudesParaContrato(Request $request){
    ...
    $listaTrabajadores=Empleador::join('solicitud_contratos as solcont','empleadors.id','=','solcont.id_empleador')
                                    ...
                                    ->select('us.*','solcont.*','empleadors.id as id_empleador','calificacion_empleador','espe.id as id_servicio','se.descripcion','se.precio_estandar','espe.nombre as especialidad','log.correo')
                                    ->get();
   ...
   public function rechazarContrato(Request $request){
    ...
    $solicitud_contrato = SolicitudContrato::join('contratos as cont','id_contrato','=','cont.id')->where('id','=',$request->id_solicitud);



        $solicitud_contrato->estado_solicitud='rechazado';
